...
public class HybridShpServer extends AbstractShpPeer {
    ...
    public HybridShpServer(int listenPort, String keyStorePath, String trustStorePath,
    ...
    public ShpServerOutput runProtocolServer() throws Exception {
        ...
        try {
            ...
            if (first == null)
                throw new RuntimeException("Hybrid SHP timeout waiting for client first message");
            runProtocol(first);
