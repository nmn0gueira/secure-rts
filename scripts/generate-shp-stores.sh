...
OUTPUT_DIR="$SCRIPT_DIR/../local/shp-stores"
PASSWORD="changeit"
VALIDITY_DAYS="3650"
FORCE="false"
...
usage() {
    cat <<EOF
Usage: bash scripts/generate-shp-stores.sh [options]
...
echo
echo "Generated local SHP stores in: $OUTPUT_DIR"
