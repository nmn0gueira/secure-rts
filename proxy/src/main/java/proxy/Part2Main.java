...
public class Part2Main {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 3) {
            System.err.println("Usage: Part2Main <server-host> <shp-port> <movie-name>");
            System.err.println();
        ...
        ShpClient shpClient = new ShpClient(serverHost, shpPort, keystorePath, truststorePath,
        ...
        Set<SocketAddress> outAddrs = Arrays.stream(destinations.split(","))
                .map(Part2Main::parseSocketAddress)
