...
public class Part3aMain {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 3) {
            System.err.println("Usage: Part3aMain <server-host> <shp-port> <movie-name>");
            System.err.println();
        ...
        HybridShpClient shpClient = new HybridShpClient(serverHost, shpPort, keystorePath, truststorePath,
        ...
        Set<SocketAddress> outAddrs = Arrays.stream(destinations.split(","))
                .map(Part3aMain::parseSocketAddress)
