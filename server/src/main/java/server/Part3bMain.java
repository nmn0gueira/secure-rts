...
public class Part3bMain {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 2) {
            System.err.println("Usage: Part3bMain <multicast-addr> <shp-tcp-port>");
            System.err.println();
        ...
        System.out.println("Part 3b (Full PQ ML-DSA + ML-KEM) server ready. Movies: " + validMovies);
        System.out.println("Listening for SHP handshakes on TCP port " + shpPort + " ...");

        while (true) {
            PqShpServer shpServer = new PqShpServer(shpPort, keystorePath, truststorePath,
            ...
            try {
                ...
                streamMovie(movieFile, out.cipherSuite(), multicastAddr, out.udpPort());
