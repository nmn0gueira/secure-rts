...
public class Part3aMain {

    public static void main(String[] args) throws Exception {
        if (args.length != 2) {
            System.err.println("Usage: Part3aMain <multicast-addr> <shp-tcp-port>");
            System.err.println();
        ...
        while (true) {
            HybridShpServer shpServer = new HybridShpServer(shpPort, keystorePath, truststorePath,
